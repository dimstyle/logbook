                    ...
                    <div className="flex items-center">
                        <div className="flex items-center w-110 h-42">
                            {AdminData?.profile_photo ? (
                                <img className="rounded-full ml-3 mt-3 mb-4 mr-3 object-cover aspect-square max-h-35 md:max-h-35 lg:max-h-35 max-w-35 md:max-w-35 lg:max-w-35" src={AdminData?.profile_photo} alt="UserIcon" />
                            ) : (
