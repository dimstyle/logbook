            ...
            <div>
                ...
                <span className="flex bg-[#C0BDBD] flex-col p-5 rounded-bl-lg rounded-br-lg gap-3">
                    ...
                    <div className="relative justify-between items-center w-full bg-white rounded-lg">
                        ...
                        <button onClick={handleToggle} className={`absolute ${showPassword ? 'bg-[#FF5454]' : 'bg-white'} inset-y-0 right-0 flex items-center pr-3 pl-3 border-l-2 border-black cursor-pointer rounded-r-lg transition-all`}><img src={NotVisible} width={25} /></button>
                    </div>
