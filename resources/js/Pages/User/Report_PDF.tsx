            ...
            <View style={styles.table}>
                ...
                {data.map((row) => (
                    <View style={styles.tableRow} key={row.id}>
                        <View style={[styles.tableCol, { display: 'flex' }, { justifyContent: 'center' }, { alignItems: 'center' }]}><Text style={[styles.tableCell, { textAlign: 'center' }, { opacity: row.laporan ? 1 : 0.5 }]}>{row.laporan || "N/A"}</Text></View>
